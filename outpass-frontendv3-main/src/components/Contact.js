...
const Contact = () => {
  ...
  useEffect(() => {
    if (submitStatus) {
      ...
      return () => clearTimeout(timer); // Cleanup on unmount or when submitStatus changes
    }
  }, [submitStatus]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let errorMessage = "Failed to send message. Please try again or contact us directly at hostel@mit.edu";
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Call Us",
      details: ["+91 7092980042", "Hostel Office: +91 7092980042", "Emergency: 24/7 Support"],
    ...
    },
    {
      ...
      title: "Email Us",
      details: ["hostel@mit.edu", "vishva2730@gmail.com", "info@mitchennai.edu"],
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="h-80 lg:h-96 bg-gradient-to-br from-blue-50 to-gray-100 flex flex-col items-center justify-center p-8 text-center">
              ...
              {/* Clickable Logo */}
              <a 
                href="https://www.google.com/maps/place/Madras+Institute+of+Technology+(MIT),+Anna+University,+Chromepet,+Chennai+-+600044"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FiMapPin className="w-16 h-16 text-blue-600 mb-4 hover:text-blue-700 transition-all cursor-pointer" />
              </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-400 text-sm">
                <div>Warden: +91 70929 80042</div>
                <div>Security: +91 98401 23456</div>
